...
import environments_rllab.maze_env_utils as maze_env_utils

# Directory that contains mujoco xml files.
MODEL_DIR = 'environments_rllab/assets'
# MODEL_DIR = 'assets'
...
class MazeEnv(gym.Env):
  ...
  def __init__(
    ...
    _, file_path = tempfile.mkstemp(text=True, suffix='.xml') #Bug fixed
